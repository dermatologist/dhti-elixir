...
1. [Fork the repo](http://help.github.com/fork-a-repo) and clone it to your local computer, and set up the upstream remote:
        ...
        git clone https://github.com/dermatologist/dhti-elixir.git
        cd dhti-elixir
        git remote add upstream https://github.com/dermatologist/dhti-elixir.git
